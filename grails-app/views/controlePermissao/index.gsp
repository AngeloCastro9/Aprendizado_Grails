            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    for(i in data.permissoes){
                        ...
                        $("#divDetalhesUsuario").append(permissao.authority+" <a href='javascript: desvincularPermissao("+permissao.id+")'>Desvincular</a><br />")
                    }
                }
            })
        }
            ...
            $.ajax({
                ...
                success: function(data){
                    if (data.mensagem=="OK"){
                        ...
                        $("#divMensagemPermissao").html("Não foi possível vincular a permissão com o usuario")
                    }
                }
            })
        }
            ...
            $.ajax({
                ...
                success: function(data){
                    if (data.mensagem=="OK"){
                        ...
                        $("#divMensagemPermissao").html("Não foi possível desvincular a permissão com o usuario")
                    }
                }
            })
        }
